...
export class RateLimiter {
    ...
    state;
    defaultLimit;
    constructor(defaultLimit = { requestsPerMinute: 60, burstSize: 10 }) {
        this.limits = new Map();
        this.state = new Map();
 ...
 */
export function initializeRateLimiter(limiter = defaultRateLimiter) {
