...
export class MCPError extends Error {
    ...
    source;
    timestamp;
    constructor(message, code = 'MCP_ERROR', statusCode = 500, source) {
        super(message);
        this.name = 'MCPError';
        this.code = code;
...
export class AuthenticationError extends MCPError {
    constructor(message = 'Authentication failed', source) {
...
export class TimeoutError extends MCPError {
    constructor(message = 'Request timeout', source) {
...
export function toMCPError(error, context) {
    ...
    if (error instanceof Error) {
        return new DataSourceError(context?.message || error.message, context?.source);
    }
    return new DataSourceError(context?.message || 'An unknown error occurred', context?.source);
}
/**
