 ...
 * Arabic punctuation
 */
export const ARABIC_PUNCTUATION_REGEX = /[\u0600-\u0605\u0609-\u060A\u060C-\u060D\u061B\u061E\u061F\u066A-\u066D]/g;
/**
 * Normalize Arabic text for consistent comparison and search
 */
export function normalizeArabic(text, options = {}) {
    const { normalizeAlif = true, normalizeHa = true, normalizeYeh = true, normalizeKashida = true, removeDiacritics = true, trimSpaces = true, } = options;
    if (!text)
        return "";
    let normalized = text;
 ...
 */
export function transliterateArabic(text, options = {}) {
 ...
 */
export const DARIJA_COMMON_WORDS = {
 ...
 */
export function arabicStringSimilarity(str1, str2) {
 ...
 */
export function toArabicIndicDigits(number) {
 ...
 */
export function fromArabicIndicDigits(text) {
    const arabicIndicToStandard = {
        "٠": "0",
        "١": "1",
        "٢": "2",
        "٣": "3",
